...
public class RobotContainer extends SwerveBase {
        ...
        public Command armPresetPosition = new InstantCommand(()->m_arm.runArmPosition(Constants.ArmConstants.ARM_PRESET_POSITION));
        ...
        public void configureOperatorButtonBindings() {
                ...
                m_operatorController.getBorCircle().whileTrue(armPresetPosition);
